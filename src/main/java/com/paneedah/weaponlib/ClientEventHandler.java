    ...
    private void update() {
        ...
        if (mainHandHeldWeaponInstance != null) {
            ...
            if (mainHandHeldWeaponInstance.isAimed()) {
                PlayerUtil.slowPlayerDown(player, SLOW_DOWN_WHILE_ZOOMING_ATTRIBUTE_MODIFIER);
            } else {
        ...
        if (spreadableExposure != null && spreadableExposure.getTotalDose() > SLOW_DOWN_WHEN_POISONED_DOSE_THRESHOLD) {
            PlayerUtil.slowPlayerDown(player, SLOW_DOWN_WHILE_POISONED_ATTRIBUTE_MODIFIER);
        } else {
            PlayerUtil.restorePlayerSpeed(player, SLOW_DOWN_WHILE_POISONED_ATTRIBUTE_MODIFIER);
        }
