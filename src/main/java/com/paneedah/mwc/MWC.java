...
@Mod(modid = ID, name = NAME, version = VERSION, dependencies = "required-after:mixinbooter@[" + MIXIN_BOOTER_VERSION + " ,);required-after:redcore@[" + RED_CORE_VERSION + ",);after:groovyscript@[" + GROOVY_SCRIPT_VERSION +",);", guiFactory = "com.paneedah.weaponlib.config.ConfigGUIFactory", updateJSON = "https://forge.curseupdate.com/836353/mwc")
