...
//		.withCapacity(CommonProxy.Remington870Mag)
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
                    if (model instanceof AKMiron1) {
                        ...
                        GlStateManager.translate(-0.1285F, -0.43F, -4.4F);
                        GlStateManager.rotate(-180f, 1f, 0f, 0f);
                        GlStateManager.scale(0.4F, 0.5F, 1.1F);
                    } else if (model instanceof AK47iron) {
                        GlStateManager.translate(-0.165F, -0.8F, -1.1F);
                        GlStateManager.scale(0F, 0F, 0F);
                ...
                .withCompatibleAttachment(Attachments.Silencer12Gauge, (model) -> {
                    GlStateManager.translate(-0.19F, -0.6F, -6.5F);
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioningLoadIterationCompleted((renderContext) -> {
                            ...
                            GlStateManager.translate(-0.575000f, 0.125000f, -1.349999f);
                        })
                        ...
                        .withFirstPersonPositioning((renderContext) -> {
                            ...
                            GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                            GlStateManager.translate(-0.18f, 0.45f, -1.3f);
...
//                GlStateManager.translate(-0.575000f, 0.125000f, -1.349999f);
                        ...
                        .withFirstPersonPositioningRecoiled((renderContext) -> {
                            ...
                            GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                            GlStateManager.translate(-0.18f, 0.4f, -0.65f);
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                            GlStateManager.translate(0.250000f, 0.100000f, -0.8f);
                            GlStateManager.rotate(-3F, 1f, 0f, 0f);
...
//              GlStateManager.rotate(5F, 0f, 1f, 0f);
                        ...
                        .withFirstPersonCustomPositioningLoadIterationCompleted(AuxiliaryAttachments.ShotgunShell.getRenderablePart(), (renderContext) -> {
                            GlStateManager.translate(0.07F, 2F, 0.7F);
                        ...
                        .withFirstPersonPositioningEjectSpentRoundAimed(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-4.3F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(0.25f, 0.25f, -1.05f);
                                }, 60, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-4.2F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(0.25f, 0.25f, -1.02f);
                                }, 80, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-1F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(0.25f, 0.2f, -1.2f);
                                }, 90, 0)
                        ...
                        .withFirstPersonCustomPositioningLoadIteration(AuxiliaryAttachments.ShotgunShell.getRenderablePart(),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.translate(0.07F, 2F, 0.5F);
                                    GlStateManager.rotate(-70F, 1f, 0f, 0f);
                                }, 250, 50),

                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.translate(0.07F, 1.15F, 0.35F);
                                    GlStateManager.rotate(-70F, 1f, 0f, 0f);
                                }, 250, 50),

                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.translate(0.1F, 0.45F, 0.7F);
                                    GlStateManager.rotate(-20F, 1f, 0f, 0f);
                                    GlStateManager.rotate(5F, 0f, 1f, 0f);
                                }, 250, 50),
                        ...
                        .withFirstPersonPositioningLoadIteration(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(40.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(-44.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.575000f, 0.125000f, -1.359999f);
                                }, 140, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.575000f, 0.125000f, -1.389999f);
                                }, 70, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(40.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(-43.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.575000f, 0.125000f, -1.379999f);
                                }, 70, 0),
                        ...
                        .withFirstPersonPositioningDrawing(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(20F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.18f, 0.45f, -1.4f);
                                }, 160, 0),
                                new Transition((renderContext) -> { // Reload position
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-3F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.18f, 0.45f, -1.45f);
                                }, 270, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.rotate(7F, 0f, 0f, 1f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.18f, 0.45f, -1.35f);
                                }, 240, 0)
                        )
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                            GlStateManager.translate(0.250000f, 0.17f, -1.3f);
...
//				// Holo Zoom
                        ...
                        .withFirstPersonPositioningRunning((renderContext) -> {
                            ...
                            GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                            GlStateManager.translate(-0.15f, 0.65f, -1.5f);
                        })
...
//                         GlStateManager.translate(0.557000f, -0.851000f, 0.200000f);
                        ...
                        .withFirstPersonLeftHandPositioningAllLoadIterationsCompleted(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(35.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.075000f, -0.650000f, 0.275000f);
                                }, 250, 50),
