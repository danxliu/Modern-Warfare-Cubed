...
//          GlStateManager.translate(0f, 0f, 1f);
                ...
                .withCompatibleAttachment(Attachments.DragunovHandguard, true, (model) -> {
                    if (model instanceof AKMiron2) {
                        GlStateManager.translate(-0.185F, -1.39F, -10.35F);
                        GlStateManager.scale(0.55F, 0.55F, 1.2F);
                    } else if (model instanceof AK47iron) {
                        GlStateManager.translate(-0.25F, -1.7F, -3.9F);
...
//            GlStateManager.rotate(-10F, 1f, 0f, 0f);
                ...
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.21F, -1.4F, -2.65F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.32F, -1.4F, -1.5F);
                ...
                .withCompatibleAttachment(Attachments.LeupoldRailScope, (player, stack) -> {
                    GlStateManager.translate(-0.155F, -1.23F, -2.8F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.195F, -1.05F, -1.9F);
                ...
                .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
                    GlStateManager.translate(-0.15F, -1.91F, -1.9F);
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.185F, -1.41F, -1.7F);
                    GlStateManager.scale(0.43F, 0.43F, 0.43F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.06F, -1.18F, -2.2F);
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.055F, -1.16F, -2.0F);
                ...
                .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                    GlStateManager.translate(-0.035F, -1.25F, -1.95F);
                ...
                .withCompatibleAttachment(Attachments.EotechHybrid2, (player, stack) -> {
                    GlStateManager.translate(-0.035F, -1.25F, -2.3F);
                    GlStateManager.scale(0.73F, 0.73F, 0.73F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.33F, -1.44F, -2.4F);
                    GlStateManager.scale(0.52F, 0.52F, 0.52F);
                }, (model) -> {
                    if (model instanceof Holo2) {
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.04F, -1.24F, -1.8F);
                ...
                .withCompatibleAttachment(Attachments.PSO1, (player, stack) -> {
                    GlStateManager.translate(0.14F, -0.9F, -1.5F);
                ...
                .withCompatibleAttachment(Attachments.KobraMount, (player, stack) -> {
                    GlStateManager.translate(-0.035F, -1.23F, -0.6F);
                    GlStateManager.scale(0.7F, 0.7F, 0.7F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                        GlStateManager.translate(-0.125F, -0.45F, -0.85F);
                ...
                .withCompatibleAttachment(Attachments.Silencer762x54, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.Dragunov98Handguard) {
                            GlStateManager.translate(-0.2F, -1.08F, -11F);
                            GlStateManager.scale(1F, 1F, 1F);
                        } else {
                            GlStateManager.translate(-0.2F, -1.14F, -12F);
                            GlStateManager.scale(1F, 1F, 1F);
                        }
                    }
                }, (model) -> {
...
//                GlStateManager.rotate(45F, 0f, 1f, 0f);
//                GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.18f, -0.20f, 1f);
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.BijiaReflex)) {
                                GlStateManager.translate(0F, 0.16f, 0.8f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.OKP7)) {
                                GlStateManager.translate(-0.05F, 0.1f, -0.2f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.PSO1)) {
                                GlStateManager.translate(-0.01F, 0.13f, -0.4f);
                            }
