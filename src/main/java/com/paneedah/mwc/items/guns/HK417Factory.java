...
//        })
                .withCompatibleAttachment(Attachments.CollapsableMOEStock, (model) -> {
                    GlStateManager.translate(0.01f, -0.17f, -0.1f);
                ...
                .withCompatibleAttachment(Attachments.HK417Receiver, true, (model) -> {
                    if (model instanceof M4Receiver) {
                        ...
                        GlStateManager.translate(-0.2F, -1.319F, -1.99f);
                        GlStateManager.scale(0.6F, 0.8F, 0.86F);
                    }
                })
                ...
                .withCompatibleAttachment(Attachments.HK417Handguard, true, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(0.13F, -1.105F, -4.4F);
                        GlStateManager.scale(0.6F, 0.6F, 1F);
                        GlStateManager.rotate(90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(-0.37F, -0.91F, -4.4F);
                        GlStateManager.scale(0.6F, 0.6F, 1F);
                        GlStateManager.rotate(-90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail3) {
                        GlStateManager.translate(-0.03F, -0.81F, -4.4F);
                        GlStateManager.scale(0.6F, 0.6F, 1F);
                        GlStateManager.rotate(180F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail5) {
                        GlStateManager.translate(-0.2F, -1.32F, -4.4f);
...
//            GlStateManager.translate(0f, 0f, 1f);
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.AR15Action, true, (model) -> {
                    GlStateManager.translate(-0.175F, -1.255F, -0.67F);
...
//                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.Laser, (p, s) -> {
                    GlStateManager.translate(0.05F, -1.115F, -3.6F);
                    GlStateManager.scale(0.8F, 0.8F, 0.8F);
                })
                .withCompatibleAttachment(Attachments.Silencer762x51, (model) -> {
                    GlStateManager.translate(-0.2F, -1.215F, -6.5F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
...
//            	 GlStateManager.rotate(-20F, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            GlStateManager.translate(0.144f, 1.06f, -0.3f);
