...
//            GlStateManager.translate(0f, 0f, 1f);
                ...
                .withCompatibleAttachment(Attachments.RPKBarrel, (model) -> {
                    if (model instanceof RPKbarrel) {
                        ...
                        GlStateManager.translate(-0.195F, -1.06F, -7.16F);
                        GlStateManager.scale(0.9F, 0.55F, 0.5F);
                    } else if (model instanceof AKMiron2) {
                        GlStateManager.translate(-0.185F, -1.32F, -7.15F);
                        GlStateManager.scale(0.55F, 0.55F, 0.68F);
                    }
                })
...
//            GlStateManager.rotate(-10F, 1f, 0f, 0f);
                ...
                .withCompatibleAttachment(Magazines.AK50Mag, (model) -> {
                    ...
                    GlStateManager.translate(0f, 0.35f, -0.21f);
                })
                ...
                .withCompatibleAttachment(Attachments.JunoGrip, (model) -> {
                    GlStateManager.translate(-0.3F, -0.35F, -4.5F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
...
//                GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                //System.out.println("Position me for Acog");
                                GlStateManager.translate(0F, 0.18f, 0.4f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
                                //System.out.println("Position me for Acog");
                                GlStateManager.translate(0F, 0.2f, 0.4f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holographic)) {
                                //System.out.println("Position me for Acog");
                                GlStateManager.translate(0F, 0.26f, 0.4f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                                //System.out.println("Position me for Acog");
                                GlStateManager.translate(0F, 0.28f, 0.4f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Kobra)) {
                                //System.out.println("Position me for Acog");
                                GlStateManager.translate(0F, 0.24f, 0.4f);
                            }
