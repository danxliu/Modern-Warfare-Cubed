...
public class MG34Factory implements GunFactory {
...
//            GlStateManager.translate(0.45F, 0F, 0F);
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
                    if (model instanceof AKMiron1) {
                        ...
                        GlStateManager.translate(0.26F, -1.555F, -6.075F);
                        GlStateManager.scale(0.15F, 0.3F, 0.45F);
...
//                GlStateManager.translate(0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            GlStateManager.translate(-0.01f, 1.1f, -1.1f);
...
//                } 
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(-0.01f, 1.1f, -0.9f);
...
//                } 
                        ...
                        .withFirstPersonHandPositioning(
                                (renderContext) -> {
                                    ...
                                    GlStateManager.rotate(30.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.050000f, -0.375000f, 0.025000f);
                                },
                                (renderContext) -> {
                                    GlStateManager.scale(4f, 4f, 4f);
                                    GlStateManager.rotate(-95.000000f, 1f, 0f, 0f);
