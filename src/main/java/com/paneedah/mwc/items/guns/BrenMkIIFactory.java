...
public class BrenMkIIFactory implements GunFactory {
...
//        })
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioningRecoiled((renderContext) -> {
                            ...
                            GlStateManager.scale(2f, 2f, 2f);
                            GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                            GlStateManager.translate(-0.675000f, 0.075000f, -2.200001f);
                        ...
                        .withFirstPersonPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.125000f, -2.300001f);
                                }, 400, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.125000f, -2.400001f);
                                }, 300, 50),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.125000f, -2.500001f);
                                }, 100, 150),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.125000f, -2.600001f);
                                }, 350, 0),
                        ...
                        .withFirstPersonPositioningUnloading(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(10.000000f, 0f, 0f, 1f);
                                    GlStateManager.rotate(4.000000f, 1f, 0f, 0f);
                                    GlStateManager.translate(-0.675000f, 0.075000f, -2.500001f);
                                }, 240, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.scale(2f, 2f, 2f);
                        ...
                        .withFirstPersonCustomPositioningUnloading(Magazines.BrenMag,
                                ...
                                new Transition((renderContext) -> {
                                    GlStateManager.translate(0.7F, 3F, 0F);
                                    GlStateManager.rotate(15F, 1f, 0f, 0f);
...
//                }, 100, 0)
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(-0.275f, -0.083f, -2.2f);
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(-0.275f, -0.083f, -2.05f);
                        ...
                        .withFirstPersonPositioningRunning((renderContext) -> {
                            ...
                            GlStateManager.rotate(10.000000f, 1f, 0f, 0f);
                            GlStateManager.translate(-0.675000f, 0.3f, -2.300001f);
                        })
                        ...
                        .withFirstPersonHandPositioning(
                                (renderContext) -> {
                                    ...
                                    GlStateManager.translate(0.125000f, -0.700000f, 0.325000f);
...
//                         GlStateManager.scale(4f, 4f, 4f);
                        ...
                        .withFirstPersonLeftHandPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.350000f, -0.825000f, -0.175000f);
                                }, 50, 200),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(10.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(50.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.375000f, -0.875000f, -0.150000f);
                                }, 250, 0),
                        ...
                        .withFirstPersonLeftHandPositioningUnloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-10.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(15.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.225000f, -1.149999f, 0.225000f);
                                }, 50, 200))
