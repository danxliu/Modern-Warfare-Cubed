...
//          GlStateManager.scale(1.15F, 1.2F, 1.2F);
                ...
                .withCompatibleAttachment(Magazines.M4A1Mag, (model) -> {
                    GlStateManager.translate(-0.322F, 0.5F, -1.25F);
                    GlStateManager.scale(0.97F, 1.5F, 1.5F);
                })
...
//            GlStateManager.scale(1.15F, 1.2F, 1.2F);
                ...
                .withCompatibleAttachment(Magazines.Stanag60, (model) -> {
                    ...
                    GlStateManager.translate(0F, 0.2F, -0.15F);
//            GlStateManager.scale(1.15F, 1.2F, 1.2F);
                })
                .withCompatibleAttachment(Magazines.Stanag100, (model) -> {
                    GlStateManager.translate(-0.36F, 0.5F, -1.31F);
                    GlStateManager.scale(1.2F, 1.2F, 1.2F);
                })
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.22F, -1.52F, -2F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.32F, -1.53F, -0.9F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.19F, -1.2F, -1F);
                ...
                .withCompatibleAttachment(Attachments.LeupoldRailScope, (player, stack) -> {
                    GlStateManager.translate(-0.154F, -1.36F, -1.7F);
                ...
                .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
                    GlStateManager.translate(-0.148F, -2.05F, -1F);
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.0555F, -1.32F, -1.5F);
                ...
                .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                    GlStateManager.translate(-0.034F, -1.38F, -1.4F);
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.054F, -1.3F, -1.3F);
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.3F, -1.56F, -1.4F);
                    GlStateManager.scale(0.45F, 0.45F, 0.45F);
                }, (model) -> {
                    if (model instanceof Holo2) {
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.04F, -1.38F, -0.99F);
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.18F, -1.57F, -1F);
                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.Bipod, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.ACRPrecisionHandGuardTan) {
                            ...
                            GlStateManager.translate(-0.18F, -0.24F, -2.5F);
                ...
                .withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
                    GlStateManager.translate(0.03F, -1.15F, -2.6F);
                    GlStateManager.scale(0.8F, 0.8F, 0.8F);
                })
