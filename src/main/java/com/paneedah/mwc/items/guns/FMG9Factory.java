...
//		.withShellCasingEjectEnabled(false)
                ...
                .withCompatibleAttachment(Magazines.GlockMag50, (model) -> {
                    GlStateManager.translate(0F, 0F, -0.08F);
                })
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.17F, -1.37F, -1.8F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.24F, -1.37F, -0.5F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.14F, -1.08F, -0.7F);
                ...
                .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
                    GlStateManager.translate(-0.11F, -1.9F, -1F);
...
//                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.029F, -1.2F, -0.9F);
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.025F, -1.15F, -1F);
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.26F, -1.42F, -1.1F);
                    GlStateManager.scale(0.45F, 0.45F, 0.45F);
                }, (model) -> {
                    if (model instanceof Holo2) {
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.005F, -1.24F, -0.7F);
                    GlStateManager.scale(0.65F, 0.65F, 0.65F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.145F, -1.4F, -1F);
...
//            	 GlStateManager.rotate(-20F, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                GlStateManager.translate(-0.00F, -0.07f, 0.1f);
                            }

                            // Reflex Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
                                GlStateManager.translate(0F, -0.035f, 0.1f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                                GlStateManager.translate(-0.00F, 0.03f, 0.2f);
                            }
