...
//        .withShellCasingSideOffset(0f)
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.StripperClip, true, (model) -> {
                    GlStateManager.translate(0F, 0.7F, 1.2F);
                })
                .withCompatibleAttachment(AuxiliaryAttachments.StripperClipBullets, true, (model) -> {
                    GlStateManager.translate(0F, 0.7F, 1.2F);
                })
                .withCompatibleAttachment(AuxiliaryAttachments.Extra, true, (model) -> {
                    if (model instanceof AKMiron1) {
                        ...
                        GlStateManager.translate(-0.02F, -0.135F, -4.1F);
                        GlStateManager.scale(0.53F, 0.53F, 0.8F);
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.JohnsonRifleSight, true, (model) -> {
                    GlStateManager.translate(-0.04F, -0.1F, 2.2F);
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioning((renderContext) -> {
                            ...
                            GlStateManager.translate(-0.500000f, -0.2f, -3.499999f);
                        })
                        ...
                        .withFirstPersonPositioningRecoiled((renderContext) -> {
                            ...
                            GlStateManager.scale(2f, 2f, 2f);
                            GlStateManager.rotate(9.000000f, 0f, 0f, 1f);
                            GlStateManager.translate(-0.500000f, -0.2f, -2.999999f);
...
//                GlStateManager.translate(-0.9F, -0.1F, 0F);
...
//                GlStateManager.rotate(-66.000000f, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningCustomZoomingRecoiled(AuxiliaryAttachments.JohnsonRifleACTION.getRenderablePart(), (renderContext) -> {
                            GlStateManager.translate(0f, 0f, 1f);
                        })
                        ...
                        .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.StripperClip.getRenderablePart(),
                        ...
                        .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.StripperClipBullets.getRenderablePart(),
                                new Transition((renderContext) -> {
                                    GlStateManager.translate(-0.5F, 1F, 0.5F);
                                }, 250, 50),
                                new Transition((renderContext) -> {
...
//                }, 100, 0)
                        ...
                        .withFirstPersonPositioningDrawing(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.375000f, -3.400001f);
                                }, 120, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.scale(2f, 2f, 2f);
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.275000f, -3.500001f);
                                }, 120, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.scale(2f, 2f, 2f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.rotate(10.000000f, 1f, 0f, 0f);
                                    GlStateManager.translate(-0.675000f, 0.175000f, -3.600001f);
                                }, 270, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.scale(2f, 2f, 2f);
                                    ...
                                    GlStateManager.translate(-0.675000f, 0.075000f, -3.700001f);
                                }, 190, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.scale(2f, 2f, 2f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.675000f, 0.075000f, -3.600001f);
                                }, 190, 0)
                        )
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.19f, -0.44f, -3.3f);
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.19f, -0.44f, -3f);
...
//                        GlStateManager.scale(4f, 4f, 4f);
                        ...
                        .withFirstPersonRightHandPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.375000f, -1.075000f, 0.450000f);
                                }, 470, 130),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(4f, 4f, 4f);
                                    ...
                                    GlStateManager.rotate(-50.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.350000f, -0.975000f, 0.250000f);
                                }, 460, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(4f, 4f, 4f);
                                    GlStateManager.rotate(-90.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.rotate(-50.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.350000f, -0.975000f, 0.075000f);
                                }, 480, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(4f, 4f, 4f);
                                    GlStateManager.rotate(-90.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.rotate(-50.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.375000f, -0.925000f, 0.200000f);
                                }, 100, 100),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(4f, 4f, 4f);
                                    GlStateManager.rotate(-90.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(10.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(-50.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.450000f, -0.925000f, 0.325000f);
                                }, 100, 0),
