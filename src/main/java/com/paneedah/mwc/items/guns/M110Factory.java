...
//        .withRecoilParam(new RecoilParam(2, 80, 1, 1, 0))
                ...
                .withCompatibleAttachment(Attachments.M110Handguard, true, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(0.13F, -1.135F, -5.2F);
                        GlStateManager.scale(0.6F, 0.6F, 1.25F);
                        GlStateManager.rotate(90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(-0.37F, -0.96F, -5.2F);
                        GlStateManager.scale(0.6F, 0.6F, 1.25F);
                        GlStateManager.rotate(-90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail3) {
                        GlStateManager.translate(-0.03F, -0.78F, -4.97F);
                        GlStateManager.scale(0.6F, 0.6F, 1.1F);
                        GlStateManager.rotate(180F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail5) {
                        GlStateManager.translate(-0.2F, -1.32F, -5.2f);
                        GlStateManager.scale(0.6F, 0.8F, 1.3F);
                    }
                })
...
//                     GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.Bipod, (model) -> {
                    GlStateManager.translate(-0.18F, -0.3F, -4.5F);
                    GlStateManager.scale(0.85F, 0.85F, 0.85F);
                })
                .withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
                    GlStateManager.translate(-0.22F, -1.18F, -3.8F);
                    GlStateManager.scale(0.8F, 0.8F, 0.8F);
                    GlStateManager.rotate(-90F, 0f, 0f, 1f);
                })
                .withCompatibleAttachment(Attachments.Laser, (p, s) -> {
                    GlStateManager.translate(0.05F, -1.13F, -4.55F);
                    GlStateManager.scale(0.7F, 0.7F, 0.7F);
                })
...
//				GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                GlStateManager.translate(-0.003F, -0.05f, 0.6f);
                            }
