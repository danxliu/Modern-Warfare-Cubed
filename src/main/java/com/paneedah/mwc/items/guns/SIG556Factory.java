...
//        })
                ...
                .withCompatibleAttachment(Attachments.CollapsableMOEStock, (model) -> {
                    GlStateManager.translate(0f, -0.225f, 0.3f);
                    GlStateManager.scale(1F, 1F, 1F);
                })
...
//          GlStateManager.scale(0.7F, 0.4F, 0.7F);
                ...
                .withCompatibleAttachment(Attachments.HK416RearSights, true, (model) -> {
                    if (model instanceof G95_upright_rearsights) {
                        GlStateManager.translate(-0.154F, -1.63F, -0.5F);
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.Extra, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.SIG556HandguardKA) {
                            GlStateManager.translate(0F, 0F, -0.563F);
// 	               GlStateManager.scale(0.29F, 0.29F, 0.29F);
                        } else {
//                	GlStateManager.translate(-0.154F, -1.63F, -0.5F);
// 	               GlStateManager.scale(0.29F, 0.29F, 0.29F);
...
//				GlStateManager.scale(0.8F, 0.68F, 1F);
                        ...
                        GlStateManager.translate(-0.185F, -1.58F, -4.435F);
                        GlStateManager.scale(0.4F, 0.45F, 0.65F);
...
//				GlStateManager.translate(-0.215F, -3F, -6F);
//                GlStateManager.scale(0.8F, 0.8F, 1.5F);
                ...
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.21F, -1.5F, -1.8F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.28F, -1.5F, -0.5F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.18F, -1.25F, -0.7F);
                ...
                .withCompatibleAttachment(Attachments.LeupoldRailScope, (player, stack) -> {
                    GlStateManager.translate(-0.151F, -1.38F, -1.4F);
                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                }, (model) -> {
                    if (model instanceof JPUreticle) {
...
//                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.066F, -1.35F, -0.9F);
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.062F, -1.32F, -1F);
                ...
                .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                    GlStateManager.translate(-0.041F, -1.38F, -0.7F);
                ...
                .withCompatibleAttachment(Attachments.EotechHybrid2, (player, stack) -> {
                    GlStateManager.translate(-0.041F, -1.38F, -1.3F);
                    GlStateManager.scale(0.65F, 0.65F, 0.65F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.3F, -1.55F, -1.1F);
                    GlStateManager.scale(0.45F, 0.45F, 0.45F);
                }, (model) -> {
                    if (model instanceof Holo2) {
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.041F, -1.39F, -0.7F);
                    GlStateManager.scale(0.65F, 0.65F, 0.65F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.18F, -1.55F, -1F);
                ...
                .withCompatibleAttachment(Attachments.Grip2, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.SIG556HandguardKA) {
                            ...
                            GlStateManager.translate(-0.2F, -0.3F, -2.7F);
                            GlStateManager.scale(1F, 1F, 1F);
                        }
                    }
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.AngledGrip, renderContext -> {
                    ...
                    if (instance != null) {
                        ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                                AttachmentCategory.GUARD, instance);
                        if (activeAttachment == Attachments.SIG556HandguardKA) {
                            GlStateManager.translate(-0.2F, 0.02F, -3.5F);
                            GlStateManager.scale(1F, 1F, 1F);
                        } else {
                            GlStateManager.translate(-0.2F, -0.1F, -3F);
                            GlStateManager.scale(1F, 1F, 1F);
                        }
                    }
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
                    GlStateManager.translate(0.05F, -1.18F, -4F);
                ...
                .withCompatibleAttachment(Attachments.Silencer556x45, (model) -> {
                    GlStateManager.translate(-0.2F, -1.12F, -7.3F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
...
//            	 GlStateManager.rotate(-20F, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.HK416RearSights)) {
                                GlStateManager.translate(0F, 0.125f, 0.1f);
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                                GlStateManager.translate(-0.01F, 0.115f, 0.3f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                GlStateManager.translate(-0.003F, 0.1f, 0.2f);
                            }

                            // HP Zoomw
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.LeupoldRailScope)) {
                                GlStateManager.translate(0.001F, 0.1f, 0f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.BijiaReflex)) {
                                GlStateManager.translate(0F, 0.09f, 0.1f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                                GlStateManager.translate(-0.004F, 0.15f, 0.2f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                                GlStateManager.translate(0F, 0.14f, 0.4f);
                            }
