...
//            GlStateManager.translate(0f, -0.28f, -0.55f);
                ...
                .withCompatibleAttachment(Attachments.AR10SuperSASSHandguard, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(0.11F, -1.17F, -4.45F);
                        GlStateManager.scale(0.6F, 0.6F, 1F);
                        GlStateManager.rotate(90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(-0.35F, -1.005F, -4.45F);
                        GlStateManager.scale(0.6F, 0.6F, 1F);
                        GlStateManager.rotate(-90F, 0f, 0f, 1f);
...
//            GlStateManager.rotate(15F, 0f, 0f, 0f);
...
//                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.Silencer50BMG, (model) -> {
                    GlStateManager.translate(-0.2F, -1.27F, -6.7F);
                    GlStateManager.scale(1.1F, 1.1F, 1.1F);
                })
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .setupModernMagazineAnimations("m110", Magazines.BeowulfMag)
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            GlStateManager.translate(0.143f, 1.06f, -0.4f);
