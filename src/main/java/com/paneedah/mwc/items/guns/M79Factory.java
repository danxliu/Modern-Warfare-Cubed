...
//      .withCapacity(CommonProxy.AR15Mag)
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withThirdPersonPositioning((renderContext) -> {
                            ...
                            GlStateManager.translate(-0.7F, -0.3F, 0.7F);
                        ...
                        .withFirstPersonPositioning((renderContext) -> {
                            ...
                            GlStateManager.translate(-0.700000f, -0.200000f, -3.024999f);
                        })
                        ...
                        .withFirstPersonPositioningRecoiled((renderContext) -> {
                            ...
                            GlStateManager.rotate(7F, 0f, 0f, 1f);
                            GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                            GlStateManager.translate(-0.700000f, -0.150000f, -2.424999f);
                        ...
                        .withFirstPersonPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                                    GlStateManager.translate(-0.700000f, 0.500000f, -2.324999f);
                                }, 400, 0),

                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(43F, 0f, 1f, 0f);
                                    GlStateManager.rotate(7F, 0f, 0f, 1f);
                                    GlStateManager.rotate(-65F, 1f, 0f, 0f);
                                    GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                                    GlStateManager.translate(-0.700000f, 1.3f, -2.124999f);
                                }, 430, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                                    GlStateManager.translate(-0.700000f, 1.55f, -2.124999f);
                                }, 200, 50),

                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(43F, 0f, 1f, 0f);
                                    GlStateManager.rotate(7F, 0f, 0f, 1f);
                                    GlStateManager.rotate(-13F, 1f, 0f, 0f);
                                    GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                                    GlStateManager.translate(-0.700000f, 0.700000f, -2.424999f);
                                }, 300, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(44F, 0f, 1f, 0f);
                                    GlStateManager.rotate(7F, 0f, 0f, 1f);
                                    ...
                                    GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                                    GlStateManager.translate(-0.700000f, 0.400000f, -3.024999f);
                                }, 260, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                        ...
                        .withFirstPersonCustomPositioningReloading(AuxiliaryAttachments.M79grenade.getRenderablePart(),
                                ...
                                new Transition((renderContext) -> {
                                    GlStateManager.translate(0F, -0.95f, 2F);
                                    GlStateManager.scale(1F, 1F, 1F);
                                    GlStateManager.rotate(20F, 1f, 0f, 0f);
                                }, 250, 1000),
                                new Transition((renderContext) -> {
                                ...
                                new Transition((renderContext) -> {
                                    GlStateManager.translate(0F, -0.7f, 0.5F);
                                    GlStateManager.scale(1F, 1F, 1F);
                                    GlStateManager.rotate(20F, 1f, 0f, 0f);
                                }, 250, 1000),
                                new Transition((renderContext) -> {
                        ...
                        .withFirstPersonPositioningDrawing(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-2F, 1f, 0f, 0f);
                                    GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                                    GlStateManager.translate(-0.700000f, -0.200000f, -2.924999f);
                                }, 160, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.rotate(7F, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.2f, -0.3f, -2.8f);
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.2f, -0.1f, -2.3f);
                            GlStateManager.rotate(-6F, 1f, 0f, 0f);
                        ...
                        .withFirstPersonPositioningRunning((renderContext) -> {
                            ...
                            GlStateManager.scale(2.000000f, 2.000000f, 2.000000f);
                            GlStateManager.translate(-0.700000f, -0.000000f, -3.024999f);
                        })
                        ...
                        .withFirstPersonHandPositioning(
                                (renderContext) -> {
                                    ...
                                    GlStateManager.translate(0.225000f, -0.800000f, 0.275000f);
                                },
                                (renderContext) -> {
                                    GlStateManager.scale(3.5f, 3.5f, 3.5f);
                                    ...
                                    GlStateManager.translate(0.650000f, -1.174999f, 0.350000f);
                                })
                        ...
                        .withFirstPersonLeftHandPositioningReloading(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.200000f, -0.800000f, 0.225000f);
                                }, 50, 200),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.150000f, -0.825000f, 0.100000f);
                                }, 50, 200),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-35.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.100000f, -0.975000f, 0.100000f);
                                }, 50, 200),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-35.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.800000f, -1.374999f, 0.050000f);
                                }, 250, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3.5f, 3.5f, 3.5f);
                                    GlStateManager.rotate(-85.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(-35.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.800000f, -1.174999f, 0.050000f);
                                }, 250, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3.5f, 3.5f, 3.5f);
                                    ...
                                    GlStateManager.rotate(40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.525000f, -1.050000f, 0.075000f);
                                }, 250, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3.5f, 3.5f, 3.5f);
                                    ...
                                    GlStateManager.rotate(-30.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.275000f, -0.950000f, 0.175000f);
                                }, 250, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3.5f, 3.5f, 3.5f);
                                    ...
                                    GlStateManager.rotate(-10.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.250000f, -0.900000f, 0.425000f);
                                }, 250, 0))
