...
//            GlStateManager.translate(-0.33F, 0.5F, -1.3F);
//            GlStateManager.scale(1.05F, 1.2F, 1F);
                })
                ...
                .withCompatibleAttachment(Attachments.Z10Handguard, true, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(-0.2F, -1.32F, -5.2f);
                        GlStateManager.scale(0.6F, 0.8F, 1.4F);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(-0.03F, -0.76F, -4.97F);
                        GlStateManager.scale(0.6F, 0.6F, 1.1F);
                        GlStateManager.rotate(180F, 0f, 0f, 1f);
                    }
                })
                .withCompatibleAttachment(Attachments.Z10Receiver, true, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(-0.2F, -1.319F, -2f);
...
//        })
                .withCompatibleAttachment(Attachments.HK416FrontSight, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.Z10Handguard) {
                ...
                .withCompatibleAttachment(Attachments.LeupoldRailScope, (player, stack) -> {
                    GlStateManager.translate(-0.151F, -1.25F, -1.6F);
                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                }, (model) -> {
                    if (model instanceof JPUreticle) {
...
//                     GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.JunoGrip, (model) -> {
                    GlStateManager.translate(-0.2F, -0.55F, -3.2F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                ...
                .withCompatibleAttachment(Attachments.Bipod, (model) -> {
                    GlStateManager.translate(-0.18F, -0.3F, -3.5F);
                ...
                .withCompatibleAttachment(Attachments.Silencer762x51, (model) -> {
                    GlStateManager.translate(-0.2F, -1.2F, -7.2F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
...
//				GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.18f, -0.02f, 0.3f);
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                                GlStateManager.translate(-0.01F, 0.03f, 0.7f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                GlStateManager.translate(-0.003F, -0.05f, 0.5f);
                            }

                            // HP Zoomw
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.LeupoldRailScope)) {
                                GlStateManager.translate(0.001F, -0.027f, 0.5f);
                            }
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.35f, 0.995f, 0.2f);
//                GlStateManager.rotate(-0.5F, 1, 0, 0);

                            // Standard Iron Sight Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), AuxiliaryAttachments.AR15Iron)) {
                                GlStateManager.translate(0F, 0.027f, -0.3f);
                            }

                            // Standard Iron Sight Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                                GlStateManager.translate(0F, 0.025f, -0.1f);
                            }
                            ...
                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                                GlStateManager.translate(-0.01F, 0.03f, 0.15f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                GlStateManager.translate(-0.003F, -0.05f, 0.1f);
                            }

                            // HP Zoomw
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.LeupoldRailScope)) {
                                GlStateManager.translate(0.001F, -0.027f, 0.1f);
                            }
                            ...
                            // Holo Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                                GlStateManager.translate(-0.004F, 0.025f, 0.15f);
                            }
