...
//                GlStateManager.translate(0F, 0F, 0.5F);
                        ...
                        GlStateManager.translate(-0.155F, -1.16F, 0.1F);
                        GlStateManager.scale(0.3F, 0.23F, 0.25F);
                    } else if (model instanceof P226frontsight) {
                        GlStateManager.translate(-0.145F, -1.16F, -2.1F);
                        GlStateManager.scale(0.22F, 0.24F, 0.22F);
                    }
                })
                ...
                .withCompatibleAttachment(Attachments.RMR, (player, stack) -> {
                    GlStateManager.translate(-0.175F, -1.35F, -1.1F);
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            GlStateManager.translate(0.145f, 0.655f, -1.9f);
