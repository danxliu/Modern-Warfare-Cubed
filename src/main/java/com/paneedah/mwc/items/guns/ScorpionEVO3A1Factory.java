...
//		.withShellCasingEjectEnabled(false)
                ...
                .withCompatibleAttachment(Attachments.ScorpionRearSight, true, (model) -> {
                    GlStateManager.translate(-0.117f, -2.37f, -0.8f);
                ...
                .withCompatibleAttachment(Attachments.ScorpionFrontSight, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.ScorpionHandguardLong) {
                            GlStateManager.translate(-0.117f, -2.37f, -3.5f);
                            GlStateManager.scale(0.55F, 0.55F, 0.55F);
                        } else {
                            GlStateManager.translate(-0.117f, -2.37f, -2f);
                            GlStateManager.scale(0.55F, 0.55F, 0.55F);
                        }
                    }
                }, (model) -> {
...
//            GlStateManager.translate(-0.175F, -1.58F, -0.86F);
//            GlStateManager.scale(0.75F, 0.43F, 0.75F);
                })
...
//        })
                .withCompatibleAttachment(Attachments.ScorpionHandguardShort, true, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(-0.215F, -1.645F, -3f);
                        GlStateManager.scale(0.7F, 0.8F, 0.5F);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(0.1F, -1.25F, -3.6f);
                        GlStateManager.scale(0.7F, 0.8F, 0.45F);
                        GlStateManager.rotate(90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail3) {
                        GlStateManager.translate(-0.35F, -1.03F, -3.6f);
                        GlStateManager.scale(0.7F, 0.8F, 0.45F);
                        GlStateManager.rotate(-90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail4) {
                        GlStateManager.translate(-0.02F, -0.83F, -3.6f);
                        GlStateManager.scale(0.7F, 0.8F, 0.45F);
                ...
                .withCompatibleAttachment(Attachments.ScorpionHandguardLong, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(-0.215F, -1.645F, -4.8f);
                        GlStateManager.scale(0.7F, 0.8F, 1F);
                    }
                })
                .withCompatibleAttachment(AuxiliaryAttachments.M4Rail, true, (model) -> {
                    if (model instanceof AKRail) {
                        GlStateManager.translate(-0.215F, -1.645F, -2.46f);
                        GlStateManager.scale(0.7F, 0.8F, 1F);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.scale(0F, 0F, 0F);
                    } else if (model instanceof AKRail3) {
                ...
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.215F, -1.72F, -2.3F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.31F, -1.75F, -0.7F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.195F, -1.4F, -1F);
                    GlStateManager.scale(0.5F, 0.5F, 0.5F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
                    GlStateManager.translate(-0.15F, -2.35F, -1F);
...
//                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.056F, -1.53F, -1.3F);
                    GlStateManager.scale(0.5F, 0.5F, 0.5F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.05F, -1.52F, -1.3F);
                ...
                .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                    GlStateManager.translate(-0.025F, -1.58F, -1.2F);
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.335F, -1.81F, -1.4F);
                    GlStateManager.scale(0.55F, 0.55F, 0.55F);
                }, (model) -> {
                    if (model instanceof Holo2) {
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.026F, -1.58F, -1F);
                    GlStateManager.scale(0.75F, 0.75F, 0.75F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.183F, -1.77F, -1F);
                ...
                .withCompatibleAttachment(Attachments.Grip2, (model) -> {
                    GlStateManager.translate(-0.21F, -0.35F, -3F);
                    GlStateManager.scale(1.1F, 1.1F, 1.1F);
                })
                .withCompatibleAttachment(Attachments.StubbyGrip, (model) -> {
                    GlStateManager.translate(-0.2F, -0.35F, -3F);
                ...
                .withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
                    GlStateManager.translate(-0.05F, -1.25F, -3.7F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                ...
                .withCompatibleAttachment(Attachments.Silencer9mm, renderContext -> {
                    ...
                    if (instance != null) {
                        ItemAttachment<Weapon> activeAttachment = WeaponAttachmentAspect.getActiveAttachment(
                                AttachmentCategory.GUARD, instance);
                        if (activeAttachment == Attachments.ScorpionHandguardLong) {
                            GlStateManager.translate(-0.2F, -1.35F, -7.5F);
                            GlStateManager.scale(1F, 1F, 1F);
                        } else {
                            GlStateManager.translate(-0.2F, -1.35F, -5.35F);
                            GlStateManager.scale(1F, 1F, 1F);
                        }
                    }
                }, (model) -> {
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withThirdPersonPositioning((renderContext) -> {
                            GlStateManager.scale(0.55F, 0.55F, 0.55F);
                            GlStateManager.translate(-2F, -0.8F, 2.1F);
...
//            	 GlStateManager.rotate(-20F, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            GlStateManager.translate(0.14f, 1.4f, -0.3f);
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                                GlStateManager.translate(-0.003F, 0.03f, 0.1f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                                GlStateManager.translate(-0.003F, 0.06f, 0.3f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                GlStateManager.translate(-0.003F, 0.02f, 0.1f);
                            }

                            // Reflex Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
                                GlStateManager.translate(0F, 0.01f, 0.1f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holographic)) {
                                GlStateManager.translate(0F, 0.08f, 0.1f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                                GlStateManager.translate(0F, 0.0555f, 0.1f);
                            }
