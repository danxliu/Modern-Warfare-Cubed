...
//          GlStateManager.translate(0.01f, -0.19f, -0.4f);
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.SupernovaPump, true, (model) -> {
                    GlStateManager.translate(0.017F, 0F, 0F);
//            GlStateManager.rotate(90F, 1f, 0f, 0f);
...
//                GlStateManager.rotate(-70F, 1f, 0f, 0f);
                        ...
                        .withFirstPersonPositioningEjectSpentRound(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.205f, 0.57f, -1.2f);
                                }, 110, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.205f, 0.57f, -1.19f);
                                }, 60, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-2F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.205f, 0.57f, -1.26f);
                                }, 80, 0),
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.205f, 0.5f, -1.4f);
                                }, 90, 0)
                        ...
                        .withFirstPersonPositioningDrawing(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.15f, 0.7f, -1.5f);
                                }, 160, 0),
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(4F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.15f, 0.5f, -1.5f);
                                }, 210, 0),
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.15f, 0.4f, -1.6f);
                                }, 270, 0),
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-2F, 1f, 0f, 0f);
                                    GlStateManager.scale(4.000000f, 4.000000f, 4.000000f);
                                    GlStateManager.translate(-0.18f, 0.5f, -1.5f);
                                }, 240, 0)
                        )
...
//              // Holo Zoom
                        ...
                        .withFirstPersonHandPositioning(
                                (renderContext) -> {
                                    ...
                                    GlStateManager.translate(0.300000f, -0.390000f, 0.315000f);
                                },
                                (renderContext) -> {
                        ...
                        .withFirstPersonLeftHandPositioningEjectSpentRound(
                                new Transition((renderContext) -> {
                                    ...
                                    GlStateManager.rotate(-35.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.120000f, -0.640000f, 0.365000f);
                                }, 250, 50),
