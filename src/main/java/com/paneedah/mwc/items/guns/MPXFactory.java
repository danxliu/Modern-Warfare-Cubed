...
//            GlStateManager.scale(1.15F, 1.2F, 1.15F);
                ...
                .withCompatibleAttachment(AuxiliaryAttachments.M4Rail, true, (model) -> {
                    if (model instanceof AKRail) {
                        ...
                        GlStateManager.translate(-0.215F, -1.645F, -2.52f);
                        GlStateManager.scale(0.7F, 0.8F, 1F);
...
//                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                ...
                .withCompatibleAttachment(Attachments.AimpointCompM2, (player, stack) -> {
                    GlStateManager.translate(-0.12F, -1.0F, -1F);
                    GlStateManager.scale(1F, 1F, 1F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.Grip2, (model) -> {
                    GlStateManager.translate(-0.2F, -0.35F, -3.2F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                ...
                .withCompatibleAttachment(Attachments.AngledGrip, (model) -> {
                    GlStateManager.translate(-0.2F, -0.23F, -3.0F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                ...
                .withCompatibleAttachment(Attachments.Bipod, (model) -> {
                    GlStateManager.translate(-0.2F, -0.25F, -3.3F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                .withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
                    GlStateManager.translate(0.12F, -1.3F, -3F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                .withCompatibleAttachment(Attachments.Laser, (p, s) -> {
                    GlStateManager.translate(0.16F, -1.28F, -3F);
                    GlStateManager.scale(1F, 1F, 1F);
                })
                .withCompatibleAttachment(Attachments.Silencer9mm, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.MPXHandguardExtended) {
                            GlStateManager.translate(-0.215F, -1.35F, -7.7F);
                            GlStateManager.scale(1.2F, 1.2F, 1.2F);
                        } else {
                            GlStateManager.translate(-0.215F, -1.35F, -5.5F);
                            GlStateManager.scale(1.2F, 1.2F, 1.2F);
                        }
                    }
                }, (model) -> {
...
//            	 GlStateManager.rotate(-20F, 0f, 0f, 1f);
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.AimpointCompM2)) {
                                GlStateManager.translate(0F, 0.0555f, 0.6f);
                            }
