...
//                GlStateManager.translate(0F, 0F, 0.5F);
                        ...
                        GlStateManager.translate(-0.107F, -1.17F, 0F);
                        GlStateManager.scale(0.22F, 0.15F, 0.4F);
                    } else if (model instanceof M1911frontsight) {
                        GlStateManager.translate(-0.107F, -1.155F, -2.05F);
                        GlStateManager.scale(0.21F, 0.24F, 0.16F);
                    }
                })
...
//                GlStateManager.translate(0F, 0F, 0.5F);
                ...
                .withCompatibleAttachment(Attachments.Laser, (p, s) -> {
                    GlStateManager.translate(0.05F, -0.65F, -2.3F);
                ...
                .withCompatibleAttachment(Attachments.GlockStock, (model) -> {
                    ...
                    GlStateManager.scale(0.9F, 1F, 1F);
                })
                .withCompatibleAttachment(Attachments.Silencer9mm, (model) -> {
                    GlStateManager.translate(-0.18F, -1.19F, -4.36F);
...
//        })
                .withCompatibleAttachment(Attachments.FABDefenseMount, (model) -> {
                    GlStateManager.translate(-0.18f, -0.53f, -1.9f);
                    GlStateManager.scale(0.6F, 0.6F, 0.7F);
                })
                .withCompatibleAttachment(Attachments.RMR, (player, stack) -> {
                    GlStateManager.translate(-0.14F, -1.35F, -1.1F);
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.015F, -1.1F, -1.4F);
