...
//          GlStateManager.rotate(70f, 0f, 0f, 1f);
                ...
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.155F, -0.75F, -0.8F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.225F, -0.77F, 0.3F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.135F, -0.5F, -0.1F);
                ...
                .withCompatibleAttachment(Attachments.LeupoldRailScope, (player, stack) -> {
                    GlStateManager.translate(-0.105F, -0.62F, -0.6F);
                    GlStateManager.scale(0.35F, 0.35F, 0.35F);
                }, (model) -> {
                    if (model instanceof JPUreticle) {
                ...
                .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
                    GlStateManager.translate(-0.1F, -1.12F, -0.2F);
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.036F, -0.6F, -0.2F);
                    GlStateManager.scale(0.35F, 0.35F, 0.35F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.036F, -0.585F, -0.2F);
                ...
                .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                    GlStateManager.translate(-0.01F, -0.63F, -0.1F);
                ...
                .withCompatibleAttachment(Attachments.EotechHybrid2, (player, stack) -> {
                    GlStateManager.translate(-0.01F, -0.63F, -0.3F);
                    GlStateManager.scale(0.55F, 0.55F, 0.55F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.22F, -0.8F, -0.2F);
                    GlStateManager.scale(0.35F, 0.35F, 0.35F);
                }, (model) -> {
                    if (model instanceof Holo2) {
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.015F, -0.63F, -0F);
                    GlStateManager.scale(0.55F, 0.55F, 0.55F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.12F, -0.77F, -0F);
                ...
                .withCompatibleAttachment(Attachments.AimpointCompM2, (player, stack) -> {
                    GlStateManager.translate(-0.08F, -0.26F, 0.3F);
                    GlStateManager.scale(0.65F, 0.65F, 0.65F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withFirstPersonPositioning((renderContext) -> {
                            ...
                            GlStateManager.translate(-0.075000f, 0.250000f, -1.125000f);
                        })
                        ...
                        .withFirstPersonPositioningRecoiled((renderContext) -> {
                            ...
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.rotate(4f, 0f, 0f, 1f);
                            GlStateManager.translate(-0.075000f, 0.250000f, -0.325000f);
...
//                  GlStateManager.scale(1f, 1f, 1f);
                        ...
                        .withFirstPersonPositioningEjectSpentRound(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.080000f, 0.260000f, -0.995000f);
                                }, 160, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(-0.120000f, 0.300000f, -0.998000f);
                                }, 110, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.150000f, 0.300000f, -0.775000f);
                                }, 80, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(-0.150000f, 0.300000f, -0.795000f);
                                }, 20, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-3.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.translate(-0.150000f, 0.300000f, -0.785000f);
                                }, 70, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.translate(-0.150000f, 0.280000f, -0.975000f);
                                }, 100, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(3.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.150000f, 0.250000f, -0.995000f);
                                }, 80, 0)
                        ...
                        .withFirstPersonPositioningEjectSpentRoundAimed(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(8.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.260000f, -0.995000f);
                                }, 160, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.300000f, -0.998000f);
                                }, 110, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(14.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.300000f, -0.775000f);
                                }, 80, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-4.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(13.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.300000f, -0.795000f);
                                }, 20, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-3.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(15.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.300000f, -0.785000f);
                                }, 70, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(10.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.280000f, -0.975000f);
                                }, 100, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(3.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.300000f, 0.250000f, -0.995000f);
                                }, 80, 0)
                        ...
                        .withFirstPersonPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(-7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.125000f, 0.225000f, -0.950000f);
                                }, 200, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(-0.125000f, 0.235000f, -0.950000f);
                                }, 350, 130),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(-0.125000f, 0.215000f, -0.950000f);
                                }, 70, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(8.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.260000f, -0.995000f);
                                }, 160, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.300000f, -0.998000f);
                                }, 110, 70),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-3.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(14.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.300000f, -0.775000f);
                                }, 80, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-4.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(13.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.300000f, -0.795000f);
                                }, 20, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-3.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(15.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.300000f, -0.785000f);
                                }, 70, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(10.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.280000f, -0.975000f);
                                }, 100, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(3.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(45.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(7.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.070000f, 0.250000f, -0.995000f);
                                }, 80, 0)
                        ...
                        .withFirstPersonPositioningUnloading(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(-0.125000f, 0.135000f, -0.950000f);
                                }, 220, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-10.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.translate(-0.125000f, 0.245000f, -0.950000f);
                                }, 100, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                        ...
                        .withFirstPersonPositioningInspecting(
                                new Transition((renderContext) -> {
                                    ...
                                    GlStateManager.rotate(-15.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.175000f, 0.125000f, -0.925000f);
                                }, 300, 600),
                                new Transition((renderContext) -> {
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(-10.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.translate(-0.050000f, 0.450000f, -0.900000f);
                                }, 350, 600)
                        )
                        ...
                        .withFirstPersonPositioningDrawing(
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(0.000000f, 0.350000f, -0.925000f);
                                }, 200, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(0.000000f, 0.320000f, -0.925000f);
                                }, 90, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(0.000000f, 0.280000f, -0.925000f);
                                }, 120, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    ...
                                    GlStateManager.translate(-0.075000f, 0.240000f, -1.025000f);
                                }, 100, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(1.000000f, 1f, 0f, 0f);
                                    ...
                                    GlStateManager.translate(-0.075000f, 0.200000f, -1.065000f);
                                }, 150, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.rotate(8f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.075000f, 0.200000f, -1.125000f);
                                }, 100, 0),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(2.500000f, 2.500000f, 2.500000f);
                                    GlStateManager.rotate(45F, 0f, 1f, 0f);
                                    GlStateManager.rotate(4f, 0f, 0f, 1f);
                                    GlStateManager.translate(-0.075000f, 0.200000f, -1.025000f);
                                }, 100, 0)
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            ...
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.translate(0.309f, 0.21f, -0.7f);

                            // HP Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(0F, 0.14f, 0.15f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(0F, 0.085f, 0.4f);
                            }

                            // HP Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.LeupoldRailScope)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(0F, 0.09f, 0.2f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(0F, 0.14f, 0.25f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(-0.005F, 0.11f, 0f);
                            }
                        ...
                        .withFirstPersonPositioningZoomingRecoiled((renderContext) -> {
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.rotate(45F, 0f, 1f, 0f);
                            GlStateManager.translate(0.309f, 0.21f, -0.6f);

                            // HP Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(0F, 0.14f, 0.1f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Specter)) {
                                //System.out.println("Position me for Scope");
                                GlStateManager.translate(0F, 0.085f, 0.35f);
                            }
                        ...
                        .withFirstPersonPositioningRunning((renderContext) -> {
                            ...
                            GlStateManager.rotate(20.000000f, 0f, 0f, 1f);
                            GlStateManager.translate(0.325000f, -0.525000f, -0.675000f);
                        })
                        ...
                        .withFirstPersonHandPositioning(
                                (renderContext) -> {
                                    ...
                                    GlStateManager.translate(0.260000f, -0.415000f, 0.290000f);
                                },
                                (renderContext) -> {
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-90.000000f, 1f, 0f, 0f);
...
//                    	 GlStateManager.scale(3f, 3f, 3f);
                        ...
                        .withFirstPersonHandPositioningModifying(
                                (renderContext) -> {
                                    ...
                                    GlStateManager.translate(0.250000f, -0.400000f, 0.325000f);
                                },
                                (renderContext) -> {
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-90.000000f, 1f, 0f, 0f);
                        ...
                        .withFirstPersonLeftHandPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(0.350000f, -1.199999f, 0.250000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    ...
                                    GlStateManager.rotate(-55.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(25.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.000000f, -1.000000f, 0.250000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-95.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(-55.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(25.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.050000f, -0.875000f, 0.250000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-95.000000f, 1f, 0f, 0f);
                        ...
                        .withFirstPersonRightHandPositioningReloading(
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.translate(0.425000f, -0.775000f, 0.150000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-35.000000f, 1f, 0f, 0f);
                                    GlStateManager.rotate(50.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(-120.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.625000f, -0.600000f, 0.000000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    ...
                                    GlStateManager.rotate(50.000000f, 0f, 1f, 0f);
                                    GlStateManager.rotate(-120.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.800000f, -0.600000f, -0.050000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-55.000000f, 1f, 0f, 0f);
                                ...
                                new Transition((renderContext) -> { // Reload position
                                    ...
                                    GlStateManager.rotate(-40.000000f, 0f, 0f, 1f);
                                    GlStateManager.translate(0.325000f, -0.600000f, -0.075000f);
                                }, 50, 200),
                                new Transition((renderContext) -> { // Reload position
                                    GlStateManager.scale(3f, 3f, 3f);
                                    GlStateManager.rotate(-85.000000f, 1f, 0f, 0f);
