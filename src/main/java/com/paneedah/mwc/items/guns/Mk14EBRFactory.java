...
public class Mk14EBRFactory implements GunFactory {
...
//        	GlStateManager.translate(0f, 0f, 0.73f);
                })
                .withCompatibleAttachment(AuxiliaryAttachments.Mk14EBRsight, true, (model) -> {
                    GlStateManager.translate(-0.125F, -1.16F, -1.334F);
...
//                GlStateManager.scale(1F, 1F, 1F);
                        ...
                        GlStateManager.translate(-0.19F, -1.34F, -8.5F);
                ...
                .withCompatibleAttachment(Attachments.M14SOCOMChassis, (model) -> {
                    if (model instanceof M14DMRSocomChassis) {
                        ...
                        GlStateManager.translate(-0.015F, -0.65F, -6f);
                        GlStateManager.scale(0.75F, 0.8F, 1F);
                ...
                .withCompatibleAttachment(Attachments.Mk14TanBody, (model) -> {
                    if (model instanceof Mk14Body) {
                        ...
                        GlStateManager.translate(-0.224F, -1.38F, -6f);
                        GlStateManager.scale(0.75F, 0.75F, 1.2F);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(-0.015F, -0.6F, -6f);
                        GlStateManager.scale(0.75F, 0.75F, 1.2F);
                        GlStateManager.rotate(180F, 0f, 0f, 1f);
                    }
                })
...
//          GlStateManager.translate(-0.2F, -1.3F, -9F);
//          GlStateManager.scale(1F, 1F, 1F);
                })
                .withCompatibleAttachment(Attachments.M14TriRailCover, (model) -> {
                    if (model instanceof M14TriRailCover) {
                        ...
                        GlStateManager.translate(0.12F, -1.25F, -6.6f);
                        GlStateManager.scale(0.7F, 0.75F, 0.75F);
                        GlStateManager.rotate(90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail2) {
                        GlStateManager.translate(-0.36F, -1.04F, -6.6f);
                        GlStateManager.scale(0.7F, 0.75F, 0.75F);
                        GlStateManager.rotate(-90F, 0f, 0f, 1f);
                    } else if (model instanceof AKRail3) {
                        GlStateManager.translate(-0.224F, -1.38F, -6.6f);
                        GlStateManager.scale(0.75F, 0.75F, 1.4F);
                    }
                })
                .withCompatibleAttachment(Attachments.M14Rail, (model) -> {
                    GlStateManager.translate(-0.21F, -1.4F, -2.7F);
                    GlStateManager.scale(1.15F, 1F, 1F);
                })
...
//            GlStateManager.rotate(-15F, 1f, 0f, 0f);
                ...
                .withCompatibleAttachment(Magazines.M14Drum50, (model) -> {
                    GlStateManager.translate(0F, 0.1F, -0.62F);
                ...
                .withCompatibleAttachment(Attachments.Silencer762x51, renderContext -> {
                    ...
                    if (instance != null) {
                        ...
                        if (activeAttachment == Attachments.Mk14TanBody) {
                            GlStateManager.translate(-0.2F, -1.3F, -9.5F);
                            GlStateManager.scale(1F, 1F, 1F);
                        } else {
                            GlStateManager.translate(-0.2F, -1.3F, -10.3F);
                            GlStateManager.scale(1F, 1F, 1F);
                        }
                    }
                }, (model) -> {
...
//                	GlStateManager.translate(-0.2F, -1.06F, -8.8F);
                            GlStateManager.scale(1F, 1F, 1F);
                        }
                    }
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.NightRaider, (player, stack) -> {
                    GlStateManager.translate(-0.21F, -1.5F, -3F);
                ...
                .withCompatibleAttachment(Attachments.LeupoldRailScope, (player, stack) -> {
                    GlStateManager.translate(-0.155F, -1.34F, -3F);
                ...
                .withCompatibleAttachment(Attachments.ACOG, (player, stack) -> {
                    GlStateManager.translate(-0.29F, -1.52F, -1.5F);
                ...
                .withCompatibleAttachment(Attachments.MicroT1, (player, stack) -> {
                    GlStateManager.translate(-0.177F, -1.5F, -3.5F);
                ...
                .withCompatibleAttachment(Attachments.AimpointCompM2, (player, stack) -> {
                    GlStateManager.translate(-0.12F, -0.74F, -3.5F);
                    GlStateManager.scale(1F, 1F, 1F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.MicroReflex, (player, stack) -> {
                    GlStateManager.translate(-0.145F, -2.02F, -3.6F);
                ...
                .withCompatibleAttachment(Attachments.Specter, (player, stack) -> {
                    GlStateManager.translate(-0.182F, -1.22F, -2F);
                    GlStateManager.scale(0.4F, 0.4F, 0.4F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.Reflex, (player, stack) -> {
                    GlStateManager.translate(-0.055F, -1.3F, -4F);
                ...
                .withCompatibleAttachment(Attachments.BijiaReflex, (player, stack) -> {
                    GlStateManager.translate(-0.052F, -1.28F, -3.9F);
                ...
                .withCompatibleAttachment(Attachments.Holographic, (player, stack) -> {
                    GlStateManager.translate(-0.027F, -1.33F, -3.7F);
                    GlStateManager.scale(0.75F, 0.75F, 0.75F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.EotechHybrid2, (player, stack) -> {
                    GlStateManager.translate(-0.027F, -1.33F, -2.4F);
                    GlStateManager.scale(0.75F, 0.75F, 0.75F);
                }, (model) -> {
                ...
                .withCompatibleAttachment(Attachments.VortexRedux, (player, stack) -> {
                    GlStateManager.translate(-0.307F, -1.53F, -4F);
                ...
                .withCompatibleAttachment(Attachments.Kobra, (player, stack) -> {
                    GlStateManager.translate(-0.033F, -1.35F, -3.5F);
                    GlStateManager.scale(0.7F, 0.7F, 0.7F);
                }, (model) -> {
                    if (model instanceof Reflex2) {
                ...
                .withCompatibleAttachment(Attachments.Grip2, (model) -> {
                    GlStateManager.translate(-0.21F, -0.07F, -4.8F);
                ...
                .withCompatibleAttachment(Attachments.Bipod, (model) -> {
                    GlStateManager.translate(-0.21F, -0.07F, -5.3F);
                    GlStateManager.scale(1.2F, 1.2F, 1.2F);
                })
                ...
                .withCompatibleAttachment(Attachments.AngledGrip, (model) -> {
                    GlStateManager.translate(-0.21F, -0.07F, -4F);
                    GlStateManager.scale(1.2F, 1.2F, 1.2F);
                })
                .withCompatibleAttachment(Attachments.Laser2, (p, s) -> {
                    GlStateManager.translate(0.03F, -1.25F, -5.5F);
                ...
                .withRenderer(new WeaponRenderer.Builder()
                        ...
                        .withActionTransform(new Transform().withPosition(0, 0, 0.95F))
                        ...
                        .withThirdPersonPositioning((renderContext) -> {
                            ...
                            GlStateManager.translate(-2.2F, -1.8F, 2.4F);
                        ...
                        .withFirstPersonPositioning(
                                new Transform()
                                        ...
                                        .withPivotPoint(-0.350000f, -2.100000f, -1.300000f)
                        ...
                        .withFirstPersonCustomPositioning(AuxiliaryAttachments.Mk14EBRaction.getRenderablePart(), (renderContext) -> {
                            if (renderContext.getWeaponInstance().getAmmo() == 0) {
                                GlStateManager.translate(0f, 0f, 0.95f);
                            }
                        })
...
//                    }, 500, 1000),
                        ...
                        .withFirstPersonPositioningZooming((renderContext) -> {
                            GlStateManager.scale(3.000000f, 3.000000f, 3.000000f);
                            GlStateManager.translate(0.142f, 0.85f, 0.7f);


                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.NightRaider)) {
                                GlStateManager.translate(0F, 0.34f, 0.4f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.ACOG)) {
                                GlStateManager.translate(0F, 0.35f, 0.4f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroT1)) {
                                GlStateManager.translate(0F, 0.305f, 2f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.AimpointCompM2)) {
                                GlStateManager.translate(0F, 0.36f, 2f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.MicroReflex)) {
                                GlStateManager.translate(0F, 0.338f, 2f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Reflex)) {
                                GlStateManager.translate(0F, 0.355f, 2f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.BijiaReflex)) {
                                GlStateManager.translate(0F, 0.345f, 2f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.Holographic)) {
                                GlStateManager.translate(0F, 0.383f, 2f);
                            }
                            ...
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.EotechHybrid2)) {
                                GlStateManager.translate(0F, 0.38f, 0.2f);
                            }

                            // ACOG Zoom
                            if (Weapon.isActiveAttachment(renderContext.getWeaponInstance(), Attachments.VortexRedux)) {
                                GlStateManager.translate(0F, 0.37f, 2f);
                            }
